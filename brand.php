...
if (!$smarty->is_cached('brand.dwt', $cache_id))
{
    ...
    $smarty->assign('brand_cat_list', brand_related_cat($brand_id)); // 相關分類
    ...
    assign_pager('brand',              $cate, $count, $size, $sort, $order, $page, '', $brand_id, 0, 0, $display); // 分頁
    assign_dynamic('brand'); // 動態內容
}
