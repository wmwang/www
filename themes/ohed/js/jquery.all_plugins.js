    ...
    imageSlidePlayer = function(object,config){
        ...
        this.factory = function(){
            ...
            if($titles.size() > 0) {
                ...
                if($.browser.msie && $.browser.version == 6.0){
                    $(this.obj + " .dkTitleBg").css("filter","progid:DXImageTransform.Microsoft.AlphaImageLoader(src='themes/ohed/images/mall_dot.png');");
                }else{
                    $(this.obj + " .dkTitleBg").css({background:"url(themes/ohed/images/mall_dot.png) no-repeat"});
                }
        ...
        this.resetclass =function(obj,i){
            $(obj).css({'float':"left",marginRight:"15px",width:"12px",overflow:"hidden",height:"12px",lineHeight:"100px",textAlign:"center",fontWeight:"800",fontSize:"12px",color:"#fff",cursor:"pointer",fontFamily:"Tahoma"});
            $(obj).eq(i).css({color:"#FFF",width:"12px",height:"12px",textDecoration:"none"});
