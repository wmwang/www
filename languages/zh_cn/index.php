...
if ($act == 'cat_rec')
{
    $rec_array = array(1 => 'best', 2 => 'new', 3 => 'hot', 4 => 'cat'); // zhangyh_100322  增加了一个元素 ，4 => 'cat'
 ...
 /**
	...
	*/	
	if($rec_type==4){
		...
		$smarty->assign($rec_array[$rec_type] . '_goods',    assign_cat_goods($cat_id,$number,'123','goods'));    // 小类下的产品		
