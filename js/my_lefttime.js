...
function showtime(obj)
{
  ...
  if (dateLeft > 0)
  {
    Temp = "剩余时间：<strong>"+hourZero+hourLeft+"</strong>"+_hour+"<strong>" + minuteZero + minuteLeft +"</strong>" + _minute + "<strong>" + secondZero + secondLeft + "</strong>" + _second;
  }
  else
  {
    if (hourLeft > 0)
    {
      Temp = "<strong>" + hourLeft + "</strong>" + _hour + "<strong>" + minuteZero + minuteLeft + "</strong>" + _minute + "<strong>" + secondZero + secondLeft + "</strong>" + _second;
    }
    else
    {
      if (minuteLeft > 0)
      {
        Temp = "<strong>" + minuteLeft + "</strong>" + _minute + "<strong>" + secondZero + secondLeft + "</strong>" + _second;
      }
      else
      {
        if (secondLeft > 0)
        {
          Temp = "<strong>" + secondLeft  + "</strong>" + _second;
        }
        else
        {
          Temp = '';
