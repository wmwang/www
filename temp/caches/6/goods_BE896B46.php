...
<div class="blank"></div>
  ...
  <div class="imgInfo">
     <a style="position:relative" href="images/200905/goods_img/32_P_1242110760641.jpg" id="zoom1" class="MagicZoom MagicThumb" title="諾基亞N85">
      <img src="images/200905/goods_img/32_G_1242110760868.jpg" alt="諾基亞N85" width="278px" height="278" style="border:1px solid #d2d0d0"/>
    
    </a>
       <a href="javascript:;" onclick="window.open('gallery.php?id=32'); return false;"><img src="themes/ohed/images/fangda.gif" style="position:absolute; left:241px; z-index:999999999; top:241px;" /></a>
      ...
      <div class="picture" id="imglist">
           ...
           <a  href="images/200905/goods_img/32_P_1242110760641.jpg"
    	rel="zoom1" 
        rev="images/200905/goods_img/32_P_1242110760641.jpg"
        title="">
        <img style="margin-left:0;" src="images/200905/thumb_img/32_thumb_P_1242110760997.jpg" alt="諾基亞N85" class="onbg" /></a>
...
<script type="text/javascript">
    ...
    <div class="clearfix" style="font-size:17px; font-family:'微軟雅黑';  padding-bottom:8px; padding-left:10px; color:#000">
      諾基亞N85       </div>
       ...
       <strong>市場價：</strong>NT$3612元 
    </dd>
           
           <dd>
                     <strong>商品貨號：</strong>ECS000032       </dd>
...
<strong>偉民帥哥價：</strong><font class="shop" id="ECS_SHOPPRICE">NT$3010元</font>  
     ...
     <li class="clearfix">
      ...
      <div style="float:left">
                                          ...
                                          <div class="catt">
  <a style="color:#666; text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="163" title="[ NT$0.00元]">黑色<input style="display:none" id="spec_value_163" type="radio" name="spec_185" value="163" checked /></a>
</div>
      ...
      <div style="float:left">
                                                                ...
                                                                <label for="spec_value_158">
                      <input type="checkbox" name="spec_210" value="158" id="spec_value_158" onclick="changePrice()" />
                      藍牙耳機 [加 NT$100.00元] </label>
                                            <label for="spec_value_159">
                      <input type="checkbox" name="spec_210" value="159" id="spec_value_159" onclick="changePrice()" />
                      數據線 [加 NT$12.00元] </label>
                                            <label for="spec_value_157">
                      <input type="checkbox" name="spec_210" value="157" id="spec_value_157" onclick="changePrice()" />
      ...
      已售出：<b class="price_all">554fcae493e564ee0dc75bdf2ebf94cagoods_sells|a:2:{s:4:"name";s:11:"goods_sells";s:8:"goods_id";i:32;}554fcae493e564ee0dc75bdf2ebf94ca</b> 件 
      ...
      <a style=" margin:0 12px 0 0;" href="javascript:addToCart(32)"><img src="themes/ohed/images/bnt_cat.gif" /></a>
      <a style=" margin:0 8px;"  href="javascript:collect(32)"> <img src="themes/ohed/images/bnt_cat2.gif" /></a>
  ...
  <h2 class="h2bg"  >購買記錄</h2>
      ...
      <div class="shuxin">
       ...
       <div>瀏覽量：31</div>
                         ...
                         <div>上市日期：2008年10月</div>
                <div>存儲卡格式：MicroSD</div>
                <div>內存容量：78MB</div>
                <div>操作系統：Symbian OS v9.3</div>
                <div>屏幕大小：2.6英寸</div>
                <div>手機制式：GSM,850,900,1800,1900</div>
                <div>理論通話時間：6.9 小時</div>
                <div>理論待機時間：363 小時</div>
...
<p><BR>
  ...
  <blockquote>
    <div style=" padding:20px;">
  <div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:32;}554fcae493e564ee0dc75bdf2ebf94ca</div>  
  </div>
     </blockquote>
      </div>
