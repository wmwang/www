<?php exit;?>a:3:{s:8:"template";a:6:{i:0;s:43:"C:/wamp/www/themes/ohed/group_buy_goods.dwt";i:1;s:47:"C:/wamp/www/themes/ohed/library/page_header.lbi";i:2;s:49:"C:/wamp/www/themes/ohed/library/category_tree.lbi";i:3;s:43:"C:/wamp/www/themes/ohed/library/history.lbi";i:4;s:43:"C:/wamp/www/themes/ohed/library/ur_here.lbi";i:5;s:47:"C:/wamp/www/themes/ohed/library/page_footer.lbi";}s:7:"expires";i:1372742093;s:8:"maketime";i:1372738493;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>P806_團購商品_ECSHOP演示站</title>
...
<script type="text/javascript" src="js/common.js"></script><script type="text/javascript" src="js/lefttime.js"></script><script type="text/javascript">
      ...
      var goodsname_not_null = "商品名不能為空！";
  </script>
</head>
<body>
 ...
 <img src="themes/ohed/images/category_tit.gif" style="float:left">
  ...
  <div id="category_tree2">
   <div id="cate" class="clearfix">
    ...
    <h1><a style="cursor:pointer" href="category.php?id=1">手機類型</a></h1>  
    ...
    <ul  >
        ...
        <div  >
    <h1><a style="cursor:pointer" href="category.php?id=6">手機配件</a></h1>  
    ...
    <ul  >
        ...
        <div style="display:none;">
    <h1><a style="cursor:pointer" href="category.php?id=12">充值卡</a></h1>  
    ...
    <ul  >
        ...
        <div style="display:none;">
    <h1><a style="cursor:pointer" href="category.php?id=16">是個好東西</a></h1>  
    ...
    <ul  >
        ...
        <div style="display:none;">
    <h1><a style="cursor:pointer" href="category.php?id=17">塑膠袋</a></h1>  
...
<div class="blank"></div>   
   ...
   <div class="box">
   <div class="box_1">
    <h3><span>團購商品詳情</span></h3>
    <div class="boxCenterList">
      <ul class="group clearfix">
      <li style="margin-right:8px; text-align:center;">
      <a href="goods.php?id=24"><img src="images/200905/thumb_img/24_thumb_G_1241971981429.jpg" alt="P806" /></a>
      </li>
      <li style="width:468px; line-height:23px;">
       團購商品： <font class="f5">P806</font><br>
                        起止時間：2009-05-15 08:00 -- 2010-05-26 08:00<br>
      價格階梯：<br />
      <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
       <tr>
          <th width="29%" bgcolor="#FFFFFF">數量</th>
         <th width="71%" bgcolor="#FFFFFF">價格</th>
        </tr>
                <tr>
          <td width="29%" bgcolor="#FFFFFF">5</td>
         <td width="71%" bgcolor="#FFFFFF">NT$1910.00元</td>
        </tr>
                <tr>
          <td width="29%" bgcolor="#FFFFFF">10</td>
         <td width="71%" bgcolor="#FFFFFF">NT$1860.00元</td>
        </tr>
              </table>
            保證金： NT$1000.00元<br />
            ...
            該團購活動已結束，正在等待處理... 當前價格： NT$1910.00元 當前定購數量： 0            </li>
      </ul>
    </div>
   </div>
  </div>
   ...
   <div class="box">
   <div class="box_1">
    <h3><span>商品屬性：</span></h3>
    <div class="boxCenterList">
    <form action="group_buy.php?act=buy" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
           <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
                            <tr>
                <td width="22%" bgcolor="#FFFFFF">顏色</td>
                <td width="78%" bgcolor="#FFFFFF">
                                                            <label for="spec_value_167">
                    <input type="radio" name="spec_185" value="167" id="spec_value_167" checked />
                    灰色 </label>
                                                      </td>
              </tr>
                            <tr>
                <td width="22%" bgcolor="#FFFFFF">配件</td>
                <td width="78%" bgcolor="#FFFFFF">
                                                            <label for="spec_value_168">
                    <input type="radio" name="spec_210" value="168" id="spec_value_168" checked />
                    數據線 </label>
                                                      </td>
              </tr>
                                          <tr>
                <td colspan="2" align="right" bgcolor="#FFFFFF"><br />
                  <font class="f_red">提示：您需要先註冊成為本站會員並且登錄後，才能參加商品團購!</font></td>
              </tr>
                          </table>
          </form>
    </div>
...
<script type="text/javascript">
var gmt_end_time = "1274803200";
var day = "天";
var hour = "小時";
var minute = "分鐘";
var second = "秒";
var end = "結束";
var now_time = 1372709694;
onload = function()
{
  try
  {
