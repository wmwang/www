...
<div class="blank"></div>
  ...
  <div class="imgInfo">
     <a style="position:relative" href="images/200905/goods_img/23_P_1241971556661.jpg" id="zoom1" class="MagicZoom MagicThumb" title="諾基亞N96">
      <img src="images/200905/goods_img/23_G_1241971556855.jpg" alt="諾基亞N96" width="278px" height="278" style="border:1px solid #d2d0d0"/>
    
    </a>
       <a href="javascript:;" onclick="window.open('gallery.php?id=23'); return false;"><img src="themes/ohed/images/fangda.gif" style="position:absolute; left:241px; z-index:999999999; top:241px;" /></a>
      ...
      <div class="picture" id="imglist">
           ...
           <a  href="images/200905/goods_img/23_P_1241971556661.jpg"
    	rel="zoom1" 
        rev="images/200905/goods_img/23_P_1241971556661.jpg"
        title="">
        <img style="margin-left:0;" src="images/200905/thumb_img/23_thumb_P_1241971556920.jpg" alt="諾基亞N96" class="onbg" /></a>
...
<script type="text/javascript">
	mypicBg();
     ...
     <div class="textInfo">
     <form action="javascript:addToCart(23)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
    <div class="clearfix" style="font-size:17px; font-family:'微軟雅黑';  padding-bottom:8px; padding-left:10px; color:#000">
      諾基亞N96       </div>
       ...
       <strong>市場價：</strong>NT$4440元 
    </dd>
           
           <dd>
                     <strong>商品貨號：</strong>ECS000023       </dd>
...
<strong>偉民帥哥價：</strong><font class="shop" id="ECS_SHOPPRICE">NT$3700元</font>  
     ...
     <li class="clearfix">
      ...
      <img src="themes/ohed/images/stars5.gif" alt="comment rank 5" />  <a href="#">（已有<font id="print">123</font>條評論）</a>
                ...
                <li class="clearfix">
       <dd><strong>註冊用戶：</strong><font class="shop" id="ECS_RANKPRICE_1">NT$3700元</font>
       </dd>
       </li>
                <li class="clearfix">
       <dd><strong>vip：</strong><font class="shop" id="ECS_RANKPRICE_2">NT$3300元</font>
       </dd>
       </li>
      ...
      <div style="float:left">
                                          ...
                                          <div class="catt">
  <a style="color:#666; text-decoration:none" class="cattsel" onclick="changeAtt(this)" href="javascript:;" name="175" title="[ NT$0.00元]">黑色<input style="display:none" id="spec_value_175" type="radio" name="spec_185" value="175" checked /></a>
</div>
      ...
      已售出：<b class="price_all">554fcae493e564ee0dc75bdf2ebf94cagoods_sells|a:2:{s:4:"name";s:11:"goods_sells";s:8:"goods_id";i:23;}554fcae493e564ee0dc75bdf2ebf94ca</b> 件 
      ...
      <a style=" margin:0 12px 0 0;" href="javascript:addToCart(23)"><img src="themes/ohed/images/bnt_cat.gif" /></a>
      <a style=" margin:0 8px;"  href="javascript:collect(23)"> <img src="themes/ohed/images/bnt_cat2.gif" /></a>
  ...
  <h2 class="h2bg"  >購買記錄</h2>
      ...
      <div class="shuxin">
       ...
       <div>瀏覽量：31</div>
                         ...
                         <div>上市日期：2008年09月</div>
                <div>內存容量：256MB</div>
                <div>操作系統：Symbian OS 9.3操作系統</div>
                <div>屏幕分辨率：320×240 像素</div>
                <div>屏幕大小：2.8英寸</div>
                <div>理論通話時間：2.5小時</div>
                <div>理論待機時間：200小時</div>
                <div>外觀樣式：滑蓋</div>
...
<p><BR>
  ...
  <blockquote>
    <div style=" padding:20px;">
  <div id="ECS_BOUGHT">554fcae493e564ee0dc75bdf2ebf94cabought_notes|a:2:{s:4:"name";s:12:"bought_notes";s:2:"id";i:23;}554fcae493e564ee0dc75bdf2ebf94ca</div>  
  </div>
     </blockquote>
      </div>
