...
<div class="f_r" style="color:#000; padding:0px 10px 0 20px">共<?php echo $this->_var['pager']['record_count']; ?>個商品 
<?php echo $this->_var['pager']['page']; ?>/<?php echo $this->_var['pager']['page_count']; ?>
  ...
  <form name="compareForm" action="compare.php" method="post" onSubmit="return compareGoods(this);">
    ...
    <div class="goodsList">
    <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_64759900_1372166865');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_64759900_1372166865']):
        $this->_foreach['no']['iteration']++;
?>
 
    <ul class="clearfix bgcolor" >
   
    <li class="thumb"><a href="<?php echo $this->_var['goods_0_64759900_1372166865']['url']; ?>"><img src="<?php echo $this->_var['goods_0_64759900_1372166865']['goods_thumb']; ?>" alt="<?php echo $this->_var['goods_0_64759900_1372166865']['goods_name']; ?>" /></a></li>
     
    <li class="goodsName">
    <a href="<?php echo $this->_var['goods_0_64759900_1372166865']['url']; ?>" class="f6">
        <?php if ($this->_var['goods_0_64759900_1372166865']['goods_style_name']): ?>
        <?php echo $this->_var['goods_0_64759900_1372166865']['goods_style_name']; ?> 
        <?php else: ?>
        <?php echo $this->_var['goods_0_64759900_1372166865']['goods_name']; ?> 
        <?php endif; ?>
      </a>
      
     <?php if ($this->_var['goods_0_64759900_1372166865']['goods_brief']): ?>
    <div class="brief"><?php echo $this->_var['goods_0_64759900_1372166865']['goods_brief']; ?></div> 
    <?php endif; ?>
    ...
    市場價：<font class="market"><?php echo $this->_var['goods_0_64759900_1372166865']['market_price']; ?></font><br />
    <?php endif; ?>
    <?php if ($this->_var['goods_0_64759900_1372166865']['promote_price'] != ""): ?>
    <?php echo $this->_var['lang']['promote_price']; ?><font class="shop"><?php echo $this->_var['goods_0_64759900_1372166865']['promote_price']; ?></font><br />
    <?php else: ?>
    <?php echo $this->_var['lang']['shop_price']; ?><font class="shop"><?php echo $this->_var['goods_0_64759900_1372166865']['shop_price']; ?></font><br />
    <?php endif; ?>
    <div class="blank"></div>
    <div class="blank"></div>
...
<a onclick="buyNumber<?php echo $this->_foreach['no']['iteration']; ?>.plus<?php echo $this->_foreach['no']['iteration']; ?>()" href="javascript:;"> <img src="themes/ohed/images/jia.gif" style="vertical-align:middle"></a>
       ...
       <a href="javascript:collect(<?php echo $this->_var['goods_0_64759900_1372166865']['goods_id']; ?>);" class="abg f6"><font>購買</font></a></div>
       <div class="bottom gray">
    <a href="javascript:addToCart(<?php echo $this->_var['goods_0_64759900_1372166865']['goods_id']; ?>)"><font>收藏</font></a></div>
...
buyNumber<?php echo $this->_foreach['no']['iteration']; ?>.goodNumber(num);
    ...
    <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_66055200_1372166865');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_66055200_1372166865']):
        $this->_foreach['no']['iteration']++;
?>
    <?php if ($this->_var['goods_0_66055200_1372166865']['goods_id']): ?>
     <div class="goodsItem goodsItem2"   <?php if (($this->_foreach['no']['iteration'] - 1) % 3 == 0): ?>style="background:none" <?php else: ?>  <?php endif; ?>>
           <a href="<?php echo $this->_var['goods_0_66055200_1372166865']['url']; ?>"><img src="<?php echo $this->_var['goods_0_66055200_1372166865']['goods_thumb']; ?>" alt="<?php echo $this->_var['goods_0_66055200_1372166865']['goods_name']; ?>" class="goodsimg" /></a> 
          
          <div class="blank5"></div>
             <p class="name f1"><a href="<?php echo $this->_var['goods_0_66055200_1372166865']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_66055200_1372166865']['name']); ?>"><?php echo $this->_var['goods_0_66055200_1372166865']['goods_name']; ?></a></p>
               <?php if ($this->_var['show_marketprice']): ?>
          市場價：<font class="market"><del><?php echo $this->_var['goods_0_66055200_1372166865']['market_price']; ?></del></font> 
          <?php endif; ?>
          
          <br/>
             
             
         <?php if ($this->_var['goods_0_66055200_1372166865']['promote_price'] != ""): ?>
         歐傑價：<font class="f1"><?php echo $this->_var['goods_0_66055200_1372166865']['promote_price']; ?></font><?php else: ?><font class="f1"><?php echo $this->_var['goods_0_66055200_1372166865']['shop_price']; ?></font>
          <?php endif; ?> 
              <br/>
       <div class="blank"></div>
       <div class="bottom blue">
       <a href="javascript:addToCart(<?php echo $this->_var['goods_0_66055200_1372166865']['goods_id']; ?>)"><font color="red">購買</font>
       </div>
       <div class="bottom gray">
       <a href="javascript:collect(<?php echo $this->_var['goods_0_66055200_1372166865']['goods_id']; ?>);" ><font>收藏</font>
       </div>
    ...
    <div class="goodsList">
    <?php $_from = $this->_var['goods_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_66723400_1372166865');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_66723400_1372166865']):
?>
  
    <ul class="clearfix bgcolor"<?php if (($this->_foreach['goods_list']['iteration'] - 1) % 2 == 0): ?>id=""<?php else: ?>id="bgcolor"<?php endif; ?>>
    <li style="margin-right:15px;">
    <a href="javascript:;" id="compareLink" onClick="Compare.add(<?php echo $this->_var['goods_0_66723400_1372166865']['goods_id']; ?>,'<?php echo addslashes($this->_var['goods_0_66723400_1372166865']['goods_name']); ?>','<?php echo $this->_var['goods_0_66723400_1372166865']['type']; ?>')" class="f6"><?php echo $this->_var['lang']['compare']; ?></a>
    </li>
    <li class="goodsName">
    <a href="<?php echo $this->_var['goods_0_66723400_1372166865']['url']; ?>" class="f6 f5">
        <?php if ($this->_var['goods_0_66723400_1372166865']['goods_style_name']): ?>
        <?php echo $this->_var['goods_0_66723400_1372166865']['goods_style_name']; ?><br />
        <?php else: ?>
        <?php echo $this->_var['goods_0_66723400_1372166865']['goods_name']; ?><br />
        <?php endif; ?>
      </a>
     <?php if ($this->_var['goods_0_66723400_1372166865']['goods_brief']): ?>
    <?php echo $this->_var['lang']['goods_brief']; ?><?php echo $this->_var['goods_0_66723400_1372166865']['goods_brief']; ?><br />
    <?php endif; ?>
    </li>
    <li>
    <?php if ($this->_var['show_marketprice']): ?>
    <?php echo $this->_var['lang']['market_price']; ?><font class="market"><?php echo $this->_var['goods_0_66723400_1372166865']['market_price']; ?></font><br />
    <?php endif; ?>
    <?php if ($this->_var['goods_0_66723400_1372166865']['promote_price'] != ""): ?>
    <?php echo $this->_var['lang']['promote_price']; ?><font class="shop"><?php echo $this->_var['goods_0_66723400_1372166865']['promote_price']; ?></font><br />
    <?php else: ?>
    <?php echo $this->_var['lang']['shop_price']; ?><font class="shop"><?php echo $this->_var['goods_0_66723400_1372166865']['shop_price']; ?></font><br />
    <?php endif; ?>
    </li>
    <li class="action">
    <a href="javascript:collect(<?php echo $this->_var['goods_0_66723400_1372166865']['goods_id']; ?>);" class="abg f6"><?php echo $this->_var['lang']['favourable_goods']; ?></a>
    <a href="javascript:addToCart(<?php echo $this->_var['goods_0_66723400_1372166865']['goods_id']; ?>)"><img src="themes/ohed/images/bnt_buy_1.gif"></a>
    </li>
    </ul>
    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </div>
