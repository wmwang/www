...
?>
  ...
  <div class="flowtit">
  <img src="themes/ohed/images/flow_car.gif" />  <span>您在购物中有任何疑问，请查阅<a href="#">帮助中心</a>或<a href="#">联系客服</a> </span>
  
  </div>
  
   <div class="flowBox">
        <form id="formCart" name="formCart" method="post" action="flow.php">
           <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0"  style="background:url(themes/ohed/images/tr1.gif) no-repeat ; height:39px;  ">
            ...
            <th class="th1" >商品</th>
              ...
              <th class="th2" ><?php echo $this->_var['lang']['goods_name']; ?></th>
    
              <?php if ($this->_var['show_marketprice']): ?>
              <th  class="th3"  >专柜价</th>
              <?php endif; ?>
              <th  class="th4" ><?php echo $this->_var['lang']['shop_prices']; ?></th>
              <th  class="th5" ><?php echo $this->_var['lang']['number']; ?></th>
              <th  class="th6" ><?php echo $this->_var['lang']['subtotal']; ?></th>
              <th  class="th7" ><?php echo $this->_var['lang']['handle']; ?></th>
            </tr>
          </table>      
          <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0 " style="border:1px solid #e3e3e3; background:url(themes/ohed/images/flow_bg.gif) repeat-x 0 0; margin:0;">
...
?>
            ...
            <a href="goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank"><img style="width:50px; height:58px;" src="<?php echo $this->_var['goods']['goods_thumb']; ?>" border="0" title="<?php echo htmlspecialchars($this->_var['goods']['goods_name']); ?>" /></a>
              </td>
...
?>
              ...
              <?php if ($this->_var['show_marketprice']): ?>
              <td class="th3" align="center" ><?php echo $this->_var['goods']['market_price']; ?></td>
              <?php endif; ?>
              <td class="th4" align="center" ><?php echo $this->_var['goods']['goods_price']; ?></td>
              <td class="th5" align="center" >
                <?php if ($this->_var['goods']['goods_id'] > 0 && $this->_var['goods']['is_gift'] == 0 && $this->_var['goods']['parent_id'] == 0): ?>
                <input type="text" name="goods_number[<?php echo $this->_var['goods']['rec_id']; ?>]" id="goods_number_<?php echo $this->_var['goods']['rec_id']; ?>" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="4" class="inputBg" style="text-align:center; width:50px;" onkeydown="showdiv(this)"/>
                <?php else: ?>
                <?php echo $this->_var['goods']['goods_number']; ?>
                <?php endif; ?>
              </td>
              <td class="th6" align="center" ><?php echo $this->_var['goods']['subtotal']; ?></td>
              <td class="th7" align="center" >
          ...
          <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0"  style=" border:1px solid #dfdfdf; border-top:none; margin:0">
            <tr>
              <td bgcolor="#ffffff">
          ...
          <tr>
            ...
            <td bgcolor="#ffffff" align="right">   <?php if ($this->_var['discount'] > 0): ?><?php echo $this->_var['your_discount']; ?><br /><?php endif; ?>
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="0"   style=" border:1px solid #dfdfdf; border-top:none; margin:0">
          <tr>
            <td bgcolor="#ffffff"> </td>
            <td bgcolor="#ffffff" align="right"><a href="./"><img src="themes/ohed/images/continue.gif" alt="continue" /></a> <a href="flow.php?step=checkout"><img src="themes/ohed/images/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
  ...
  <div class="flowBox">
    <h6 class=" "><span><?php echo $this->_var['lang']['label_collection']; ?></span></h6>
...
?>
  ...
  <div class="block" >
    <div class="flow_fitt">
    <h6><span>打包特惠商品</span>全场购买一件正常商品,即可享受以下特惠价!（请在此页面放入购物车）</h6>
...
?>
            <ul class="clearfix">
              ...
              <li>
                <a href="<?php echo $this->_var['fittings']['url']; ?>" target="_blank" title="<?php echo htmlspecialchars($this->_var['fittings']['goods_name']); ?>" class="f6"><?php echo htmlspecialchars($this->_var['fittings']['short_name']); ?></a> 
                <font class="f1">优惠价：<?php echo $this->_var['fittings']['fittings_price']; ?></font> 
              
                <a href="javascript:fittings_to_flow(<?php echo $this->_var['fittings']['goods_id']; ?>,<?php echo $this->_var['fittings']['parent_id']; ?>)"><img src="themes/ohed/images/bnt_buy.gif" alt="<?php echo $this->_var['lang']['collect_to_flow']; ?>" /></a>
              </li>
            </ul>
          <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        </div>
...
?><br />
            ...
            <tr>
              ...
              <td align="center" bgcolor="#ffffff"><input type="image" src="themes/ohed/images/bnt_cat.gif" alt="Add to cart"  border="0" /></td>
            </tr>
            <?php endif; ?>
          </table>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;">
            <input type="image" src="themes/ohed/images/bnt_subOrder.gif" />
        ...
        <table width="100%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
          <tr>
            ...
            <td colspan="2"  bgcolor="#ffffff"><input type="checkbox" value="1" name="remember" id="remember" /><label for="remember"><?php echo $this->_var['lang']['remember']; ?></label></td>
                  ...
                  <tr>
                    <td bgcolor="#ffffff" colspan="2" align="center"><a href="user.php?act=get_password" class="f6"><?php echo $this->_var['lang']['forgot_password']; ?></a></td>
                  </tr>
                  <tr>
