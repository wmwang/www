...
<img src="themes/ohed/images/user_dl.gif"  style="padding-bottom:10px;"/>
  ...
  <div class="usBox_1 f_l"  >
   <form name="formLogin" action="user.php" method="post" onSubmit="return userLogin()">
        <table width="100%" border="0" align="left" cellpadding="3" cellspacing="5">
          <tr>
            <td width="15%" align="right"><b>用户名：</b></td>
            <td width="85%"><input name="username" type="text"  class="inputBg"  /></td>
          </tr>
          <tr>
            <td align="right"><b>密 码：</b></td>
            <td>
            <input name="password" type="password"  class="inputBg"  />            </td>
          </tr>
            <tr>
             <td align="right"><b><?php echo $this->_var['lang']['comment_captcha']; ?>：</b></td><td><input style="width:100px; vertical-align:middle" type="text" size="8" name="captcha2" class="inputBg" />
                <img src="captcha.php?is_login=1&amp;<?php echo $this->_var['rand']; ?>" alt="captcha" style="vertical-align: middle;cursor: pointer;" onclick="this.src='captcha.php?is_login=1&amp;'+Math.random()" /> </td></tr>
          <?php if ($this->_var['enabled_captcha']): ?>
          <tr>
            <td align="right">&nbsp; </td>
            <td> <a href="user.php?act=qpassword_name" class="f3"><?php echo $this->_var['lang']['get_password_by_question']; ?></a>&nbsp;&nbsp;&nbsp;<a href="user.php?act=get_password" class="f3"><?php echo $this->_var['lang']['get_password_by_mail']; ?></a></td>
          </tr>
          <?php endif; ?>
           <tr>
  ...
  <div class="usTxt">
  <img src="themes/ohed/images/uesr_img1.gif" />
<div class="t">
<p>①、注册成功即送<b>600香币</b> </p>
<p>②、邮箱验证成功送全场抵用<b>10元红包</b>一个</p>
</div>
<div class="b">
还不是本站会员？<br/>
<a href="user.php?act=register"><img src="themes/ohed/images/bnt_ur_reg.gif" /></a>
</div>
...
<div class="usBox clearfix"  >
<img src="themes/ohed/images/user_zc.gif" style="padding-bottom:10px;" />
  <div class="usBox_1 f_l" style="padding:20px 0 0 20px; width:565px; "  >
    <form action="user.php" method="post" name="formUser" onsubmit="return register();">
      <table width="100%"  border="0" align="left" cellpadding="5" cellspacing="3">
        <tr>
          <td width="18%" align="right"> <?php echo $this->_var['lang']['label_username']; ?>： </td>
          <td width="72%">
...
我已有账号，我要登录 
<br/>
<a href="user.php"><img src="themes/ohed/images/bnt_ur_log.gif" /></a>
</div>
