 ...
 <img src="themes/ohed/images/zuhe.gif" style="float:left">
  ...
  <form class="taozhuang" action="flow.php?step=cart" method="post" name="ECS_ALL_addcart" >
   ...
   <img class="jia"   src="themes/ohed/images/jia2.gif">
    ...
    <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_65648800_1373360246');$this->_foreach['no'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['no']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_65648800_1373360246']):
...
?>
    ...
    <ul class="div_ul">
      <li  >
      <a href="<?php echo $this->_var['goods_0_65648800_1373360246']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods_0_65648800_1373360246']['goods_thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_65648800_1373360246']['name']); ?>" class="B_blue" /></a>
      </li>
      <li>
      <a href="<?php echo $this->_var['goods_0_65648800_1373360246']['url']; ?>" class="name" target="_blank" title="<?php echo htmlspecialchars($this->_var['goods_0_65648800_1373360246']['goods_name']); ?>"><?php echo htmlspecialchars($this->_var['goods_0_65648800_1373360246']['short_name']); ?></a> 
     <font class="f1"><?php echo $this->_var['goods_0_65648800_1373360246']['fittings_price']; ?></font> <input name="box[]" type="checkbox" id="goods_ids" value="<?php echo $this->_var['goods_0_65648800_1373360246']['fittings_price_nformat']; ?>"  onClick="qq(<?php echo $this->_var['goods_0_65648800_1373360246']['goods_id']; ?>);"> 
	 
	 <input name="goods_id[]" style="display:none;"  type="checkbox" id="goods_id_<?php echo $this->_var['goods_0_65648800_1373360246']['goods_id']; ?>" value="<?php echo $this->_var['goods_0_65648800_1373360246']['goods_id']; ?>" > 
