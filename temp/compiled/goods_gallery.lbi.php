...
?>
        ...
        <img style="margin-left:0;" src="<?php if ($this->_var['picture']['thumb_url']): ?><?php echo $this->_var['picture']['thumb_url']; ?><?php else: ?><?php echo $this->_var['picture']['img_url']; ?><?php endif; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>" class="onbg" /></a>
           <?php else: ?>
  <a  href="<?php echo $this->_var['picture']['img_url']; ?>"
    	rel="zoom1" 
        rev="<?php echo $this->_var['picture']['img_url']; ?>"
